 ...
 *
 * Authored by: Adam Bienkowski <donadigos159@gmail.com>
 * 
 * Authored by: Joseph Diragi <joyod3@gmail.com>
 */
using Granite.Widgets;

namespace Application {
public class PersistentPlaceholderEntry : Gtk.Entry {
    ...
    private Pango.Color get_placeholder_text_color () {
        ...
        color.blue = (uint16)(fg.green * 65535 + 0.5).clamp (0, 65535);
        return color;
    }
}
}
